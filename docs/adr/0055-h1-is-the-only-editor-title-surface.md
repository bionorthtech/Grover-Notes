...
**The editor body is now the only title surface. Grover never renders a separate title section above the editor, regardless of whether a note currently has an H1.**
