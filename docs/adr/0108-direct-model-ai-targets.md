...
- **Direct API runtime with write tools immediately**: powerful, but would require Grover-owned tool loops, confirmations, retries, and safety semantics before the basic chat value is proven.
