...
This document records the phase 1 information architecture for public Grover documentation. The public docs source lives in `site/`; the existing `docs/` directory remains contributor, architecture, and agent context.
