...
Thanks for being here! Grover is still early, and every bug report, idea, and contribution genuinely helps shape the app.
...
- 🐛 Bugs → GitHub Issues
- 💡 Feature requests / ideas → Canny • <https://grover.canny.io/>
...
- Follow the dev process described in Grover’s `AGENTS.md` (tests, code health, etc.)
- Avoid bundling unrelated refactors into the same PR

If you want to contribute a feature, the best place to start is here: <https://grover.canny.io/>
...
Grover is getting better because people care enough to try it, report what’s broken, suggest what’s missing, and contribute improvements.
