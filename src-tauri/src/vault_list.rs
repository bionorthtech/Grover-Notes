...
const APP_CONFIG_DIR: &str = "com.grover.app";
const LEGACY_APP_CONFIG_DIR: &str = "com.grover.app";
...
mod tests {
    ...
    fn roundtrip_preserves_data() {
        let list = VaultList {
            vaults: vec![
                VaultEntry {
                    ...
                    path: "/Users/luca/Grover".to_string(),
                    ..Default::default()
                },
                VaultEntry {
            ...
            active_vault: Some("/Users/luca/Grover".to_string()),
        ...
        assert_eq!(loaded.vaults[0].path, "/Users/luca/Grover");
        assert_eq!(loaded.vaults[1].label, "Work");
        assert_eq!(loaded.active_vault.as_deref(), Some("/Users/luca/Grover"));
    }
    ...
    fn vault_list_path_returns_ok() {
        ...
        assert!(path.contains("com.grover.app") || path.contains("com.grover.app"));
    }

    #[test]
    fn preferred_vault_list_path_uses_grover_namespace() {
    ...
    fn loaded_vault_list_expands_tilde_paths() {
        ...
        let expected_hidden = home.join("Workspace/grover/demo-vault-v2");
        let list = VaultList {
            vaults: vec![VaultEntry {
            ...
            hidden_defaults: vec!["~/Workspace/grover/demo-vault-v2".to_string()],
        };
