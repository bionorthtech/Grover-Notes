...
pub fn init_sentry_from_settings() -> bool {
    ...
    sentry::configure_scope(|scope| {
        ...
        scope.set_tag("grover.build_version", build_version);
        scope.set_tag("grover.release_kind", sentry_release_kind(build_version));
    });
...
mod tests {
    ...
    fn test_scrub_paths_unix() {
        assert_eq!(
            scrub_paths("Error at /Users/luca/Grover/note.md"),
