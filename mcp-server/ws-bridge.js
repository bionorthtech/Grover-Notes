#!/usr/bin/env node
/**
 * WebSocket bridge for Grover MCP tools.
 *
 * Exposes vault operations over WebSocket so the Grover app frontend
 ...
 * is unavailable (e.g. another Grover instance owns it).
 */
