...
const APP_CONFIG_DIR = 'com.grover.app'
const LEGACY_APP_CONFIG_DIR = 'com.grover.app'
...
export function requireVaultPaths(env = process.env, options = {}) {
  ...
  if (vaultPaths.length === 0) {
    ...
    throw new Error('VAULT_PATH is required. Open a vault in Grover before starting MCP tools.')
  }
  return vaultPaths
}
