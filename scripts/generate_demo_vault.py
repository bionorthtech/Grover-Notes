...
PROJECTS = [
    ...
    ("24q4-grover-start","Start Grover App Project","24q4","responsibility-learning","Done","Begin building Grover — a custom Tauri desktop app for managing the personal knowledge vault."),
    ...
    ("25q1-grover-v1","Grover App V1","25q1","responsibility-learning","Done","Ship the first working version of Grover with 4-panel layout, inspector, and quick open."),
    ...
    ("25q2-grover-v2","Grover App V2","25q2","responsibility-learning","Done","V2 with BlockNote editor, wiki-links autocomplete, and redesigned theme system."),
    ...
    ("25q4-grover-v3","Grover App V3","25q4","responsibility-learning","Open","V3: mobile sync, AI note linking, and quick capture from menu bar."),
...
GOALS = [
    ...
    ("2025-ship-grover","Ship Grover App","2025","Done","Build and use Grover v1 as my daily knowledge management tool."),
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate the large synthetic Grover fixture.")
    parser.add_argument(
        "--output",
        type=Path,
