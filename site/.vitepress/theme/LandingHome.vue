...
const docsLinks: DocsLink[] = [
  {
    ...
    text: "Install Grover, open the Getting Started vault, and understand the first-launch flow.",
    link: "/start/install",
  },
  {
    icon: "network",
  ...
  <main class="grover-landing">
    <section class="landing-container hero-section">
      ...
      <div class="hero-actions">
        ...
        <a class="landing-button secondary" href="https://github.com/bionorthtech/grover-notes">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
      ...
      >
        <div class="screenshot-frame">
          <img
            ...
            :src="asset('grover-screenshot.png')"
            alt="Grover app in light mode"
            draggable="false"
          />
          <img
            class="screenshot-image dark"
            :src="asset('grover-screenshot-dark.png')"
            alt="Grover app in dark mode"
            draggable="false"
          />
        </div>
      </div>
    ...
    <section id="about" class="about-section">
      <div class="landing-container">
        <div class="section-heading">
          ...
          <p>
            Grover is the product of the learnings from 5 years of full-time
        ...
        <div class="author-card">
          ...
          <div class="author-copy">
            ...
            <p>
              Grover is born from 5 years of full-time writing at Refactoring,
    ...
    <section class="final-cta">
      <div class="landing-container final-cta-inner">
        ...
        <p>
          Subscribe to the Refactoring newsletter for updates on Grover, new
...
<style scoped>
.grover-landing {
  --landing-bg: var(--grover-bg);
  --landing-surface: var(--grover-surface);
  --landing-dark: #1a1a18;
  --landing-text: var(--grover-text);
  --landing-muted: var(--grover-text-secondary);
  --landing-tertiary: var(--grover-text-muted);
  --landing-border: var(--grover-border);
  --landing-subtle: var(--grover-surface-muted);
  --landing-blue: #155dff;
  --landing-blue-hover: #4a5ad6;
  --landing-accent: var(--landing-blue);
  --landing-blue-soft: var(--grover-blue-soft);
...
.dark .grover-landing .screenshot-image.light {
  display: none;
}

.dark .grover-landing .screenshot-image.dark {
  display: block;
}
</style>
