...
const githubStarsCacheKey = "grover:github-stars";
const githubStarsCacheTtlMs = 60 * 60 * 1000;
const githubRepoApiUrl = "https://api.github.com/repos/bionorthtech/grover-notes";
...
const scrollClass = "grover-scrolled";
const landingPageClass = "grover-landing-page";
...
<template>
  <div :class="{ 'grover-landing-shell': frontmatter.landing }">
    <DefaultTheme.Layout>
      <template #nav-bar-content-after>
        <a
          class="github-star-widget"
          href="https://github.com/bionorthtech/grover-notes"
          target="_blank"
          rel="noreferrer"
