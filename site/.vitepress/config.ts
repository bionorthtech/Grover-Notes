...
export default defineConfig({
  title: "Grover",
  description:
    "Grover is a local-first Markdown knowledge base with native relationships, Git history, and AI workflows.",
  base,
  ...
  themeConfig: {
    logo: { src: "/landing/grover-icon.png", alt: "Grover" },
    nav: [
      ...
      { text: "Downloads", link: "https://grover.md/download/", target: "_self", noIcon: true },
    ],
    search: {
      provider: "local",
    },
    sidebar: [
      {
        text: "Start Here",
        items: [
          { text: "Install Grover", link: "/start/install" },
    ...
    footer: {
      ...
      copyright:
        "Grover is AGPL-3.0-or-later. The Grover name and logo remain covered by the project trademark policy.",
    },
  },
});
