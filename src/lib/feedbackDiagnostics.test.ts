...
describe('feedbackDiagnostics', () => {
  ...
  it('sanitizes recent warnings and errors before building the bundle', () => {
    ...
    console.error(`Load failed for /Users/luca/Grover/private.md with token ${sampleToken}`)
    ...
    expect(bundle).toContain('Grover sanitized diagnostics')
    ...
    expect(bundle).not.toContain('/Users/luca/Grover/private.md')
