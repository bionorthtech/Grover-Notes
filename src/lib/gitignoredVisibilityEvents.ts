...
export const TOGGLE_GITIGNORED_VISIBILITY_EVENT = 'grover:toggle-gitignored-visibility'
export const GITIGNORED_VISIBILITY_CHANGED_EVENT = 'grover:gitignored-visibility-changed'
export const GITIGNORED_VISIBILITY_APPLIED_EVENT = 'grover:gitignored-visibility-applied'
