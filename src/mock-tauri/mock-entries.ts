...
export const MOCK_ENTRIES: VaultEntry[] = [
  ...
  {
    path: '/Users/luca/Grover/grow-newsletter.md',
  ...
  {
    path: '/Users/luca/Grover/manage-sponsorships.md',
  ...
  {
    path: '/Users/luca/Grover/write-weekly-essays.md',
  ...
  {
    path: '/Users/luca/Grover/run-sponsorships.md',
  ...
  {
    path: '/Users/luca/Grover/stock-screener.md',
  ...
  {
    path: '/Users/luca/Grover/facebook-ads-strategy.md',
    filename: 'facebook-ads-strategy.md',
    title: 'Facebook Ads Strategy',
    isA: 'Note',
    aliases: [],
    belongsTo: ['[[26q1-grover-app]]'],
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['26q1-grover-app', 'growth', 'ads'],
    properties: { Priority: 'Medium', Rating: 4 },
    organized: false, favorite: false, favoriteIndex: null, listPropertiesDisplay: [], hasH1: false,
  },
  {
    path: '/Users/luca/Grover/budget-allocation.md',
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['26q1-grover-app'],
    properties: {},
    organized: false, favorite: false, favoriteIndex: null, listPropertiesDisplay: [], hasH1: false,
  },
  {
    path: '/Users/luca/Grover/matteo-cellini.md',
  ...
  {
    path: '/Users/luca/Grover/maria-bianchi.md',
  ...
  {
    path: '/Users/luca/Grover/marco-verdi.md',
  ...
  {
    path: '/Users/luca/Grover/elena-russo.md',
  ...
  {
    path: '/Users/luca/Grover/2026-02-14-grover-app-kickoff.md',
    filename: '2026-02-14-grover-app-kickoff.md',
    title: 'Grover App Design Session',
    isA: 'Event',
    aliases: [],
    belongsTo: [],
    relatedTo: ['[[26q1-grover-app]]', '[[matteo-cellini]]'],
    status: null,
    archived: false,
    ...
    wordCount: 310,
    relationships: {
      'Related to': ['[[26q1-grover-app]]', '[[matteo-cellini]]'],
      'Type': ['[[event]]'],
    },
    icon: null,
    color: null,
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['26q1-grover-app', 'matteo-cellini'],
    properties: {},
    organized: false, favorite: false, favoriteIndex: null, listPropertiesDisplay: [], hasH1: false,
  },
  {
    path: '/Users/luca/Grover/software-development.md',
  ...
  {
    path: '/Users/luca/Grover/trading.md',
    filename: 'trading.md',
    title: 'Trading',
    isA: 'Topic',
  ...
  {
    path: '/Users/luca/Grover/on-writing-well.md',
  ...
  {
    path: '/Users/luca/Grover/engineering-leadership-101.md',
  ...
  {
    path: '/Users/luca/Grover/ai-agents-primer.md',
  ...
  // --- Type documents ---
  {
    path: '/Users/luca/Grover/project.md',
    filename: 'project.md',
    title: 'Project',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/procedure.md',
  ...
  {
    path: '/Users/luca/Grover/experiment.md',
  ...
  {
    path: '/Users/luca/Grover/person.md',
    filename: 'person.md',
    title: 'Person',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/event.md',
    filename: 'event.md',
    title: 'Event',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/topic.md',
    filename: 'topic.md',
    title: 'Topic',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/essay.md',
    filename: 'essay.md',
    title: 'Essay',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/note.md',
    filename: 'note.md',
    title: 'Note',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/config.md',
    filename: 'config.md',
    title: 'Config',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/recipe.md',
    filename: 'recipe.md',
    title: 'Recipe',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/book.md',
    filename: 'book.md',
    title: 'Book',
    isA: 'Type',
    aliases: [],
  ...
  {
    path: '/Users/luca/Grover/config/agents.md',
    filename: 'agents.md',
  ...
  {
    path: '/Users/luca/Grover/pasta-carbonara.md',
  ...
  {
    path: '/Users/luca/Grover/designing-data-intensive-applications.md',
  ...
  // --- Archived entries ---
  {
    path: '/Users/luca/Grover/25q3-website-redesign.md',
  ...
  {
    path: '/Users/luca/Grover/twitter-thread-experiment.md',
  ...
  {
    path: '/Users/luca/Grover/refactoring.md',
  ...
  {
    path: '/Users/luca/Grover/refactoring-ideas.md',
  ...
  {
    path: '/Users/luca/Grover/refactoring-key-ideas.md',
  ...
  {
    path: '/Users/luca/Grover/refactoring-patterns.md',
...
function generateBulkEntries(count: number): VaultEntry[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    entries.push({
      path: `/Users/luca/Grover/${slug}.md`,
      filename: `${slug}.md`,
      title,
      isA: type,
      aliases: [],
