...
export const mockEntries: VaultEntry[] = [
  makeEntry({
    path: '/Users/luca/Grover/project/26q1-grover-app.md',
    filename: '26q1-grover-app.md',
  ...
  makeEntry({
    path: '/Users/luca/Grover/note/facebook-ads-strategy.md',
    filename: 'facebook-ads-strategy.md',
    title: 'Facebook Ads Strategy',
    isA: 'Note',
    belongsTo: ['[[project/26q1-grover-app]]'],
    ...
    relationships: {
      'Belongs to': ['[[project/26q1-grover-app]]'],
      'Related to': ['[[topic/growth]]'],
    },
  }),
  makeEntry({
    path: '/Users/luca/Grover/person/matteo-cellini.md',
  ...
  makeEntry({
    path: '/Users/luca/Grover/event/2026-02-14-kickoff.md',
  ...
  makeEntry({
    path: '/Users/luca/Grover/topic/software-development.md',
