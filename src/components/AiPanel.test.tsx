...
describe('AiPanel', () => {
  ...
  it('clicking a wikilink in AI response calls onOpenNote with the target', () => {
    mockMessages = [{
      ...
      actions: [],
      response: 'Check out [[Build Grover App]] for details.',
      id: 'msg-1',
    }]
    ...
    expect(wikilink!.textContent).toBe('Build Grover App')
    fireEvent.click(wikilink!)
    expect(onOpenNote).toHaveBeenCalledWith('Build Grover App')
  })
