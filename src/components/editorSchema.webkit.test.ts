...
describe('editor schema code block highlighting', () => {
  it('uses the light Shiki theme first in light mode', async () => {
    ...
    const { createGroverCodeBlockOptions } = await import('./codeBlockOptions')
    const highlighter = await createGroverCodeBlockOptions().createHighlighter?.()
  ...
  it('registers Go as a selectable Shiki code block language', async () => {
    ...
    const { createGroverCodeBlockOptions } = await import('./codeBlockOptions')
    const options = createGroverCodeBlockOptions()
  ...
  it('omits the Shiki highlighter when WebKit lacks precompiled regex flags', async () => {
    ...
    expect(createGroverCodeBlockOptions()).not.toHaveProperty('createHighlighter')
  })
