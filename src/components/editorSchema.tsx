...
import { createGroverCodeBlockOptions } from './codeBlockOptions'
...
export function GroverAudioBlock(props: AudioBlockProps) {
...
export function GroverVideoBlock(props: VideoBlockProps) {
  const externalMediaPreview = useExternalMediaPreview()
...
const codeBlock = createCodeBlockSpec(createGroverCodeBlockOptions())
