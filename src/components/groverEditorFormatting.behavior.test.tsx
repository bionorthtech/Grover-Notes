...
vi.mock('./groverEditorFormattingConfig', () => ({
  filterGroverFormattingToolbarItems: (items: ReactNode[]) => items,
...
describe('groverEditorFormatting behavior', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('renders toolbar controls, inserts the inline code button, and updates block types', () => {
    ...
    render(<GroverFormattingToolbar />)
  ...
  it('opens selected file blocks through the active vault path', () => {
    ...
    render(<GroverFormattingToolbar vaultPath="/vault" />)
  ...
  it('uses block alignment when deciding the floating placement', () => {
    ...
    render(<GroverFormattingToolbarController />)
  ...
  it('adds viewport-clamping middleware and preserves caller middleware', () => {
    ...
    expect(floatingOptions.middleware.map((middleware) => middleware.name)).toEqual(
      expect.arrayContaining(['custom-middleware', 'groverViewportClamp']),
    )
  })
  ...
  it('keeps the toolbar open during close grace and clears the timeout on unmount', () => {
    ...
    const { rerender, unmount } = render(<GroverFormattingToolbarController />)

    showState.value = false
    rerender(<GroverFormattingToolbarController />)
  ...
  it('binds composition listeners after BlockNote provides its editor element', () => {
    ...
    const { rerender } = render(<GroverFormattingToolbarController />)
