...
const vaults: VaultOption[] = [
  { label: 'Main Vault', path: '/Users/luca/Grover', alias: 'main', mounted: true },
...
describe('StatusBar', () => {
  ...
  it('does not display the bottom-bar note count readout', () => {
    render(<StatusBar noteCount={9200} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} />)
    expect(screen.queryByText('9,200 notes')).not.toBeInTheDocument()
  })

  it('displays build number when provided', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} buildNumber="b223" />)
    expect(screen.getByText('b223')).toBeInTheDocument()
  })

  it('displays fallback build number when not provided', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} />)
    expect(screen.getByText('b?')).toBeInTheDocument()
  })

  it('shows the vault reload badge while a reload is active', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} isVaultReloading />)
  ...
  it('calls onCheckForUpdates when clicking build number', () => {
    ...
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} buildNumber="b281" onCheckForUpdates={onCheckForUpdates} />)
    fireEvent.click(screen.getByTestId('status-build-number'))
    expect(onCheckForUpdates).toHaveBeenCalledOnce()
  })

  it('build number shows the update tooltip on focus', async () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} buildNumber="b281" onCheckForUpdates={vi.fn()} />)
  ...
  it('shows Contribute button when callback is provided', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onOpenFeedback={vi.fn()} />)
  ...
  it('calls onOpenFeedback when Contribute is clicked', () => {
    ...
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onOpenFeedback={onOpenFeedback} />)
  ...
  it('shows and opens Docs from the bottom bar', () => {
    ...
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onOpenDocs={onOpenDocs} />)
  ...
  it('calls onSwitchVault when selecting a different vault', () => {
    const onSwitchVault = vi.fn()
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={onSwitchVault} />)
  ...
  it('sets the default workspace instead of switching vaults after multi-workspace opt-in', () => {
    ...
    render(
      <StatusBar
        noteCount={100}
        vaultPath="/Users/luca/Grover"
        defaultWorkspacePath="/Users/luca/Grover"
        vaults={vaults}
        multiWorkspaceEnabled={true}
        onSwitchVault={onSwitchVault}
  ...
  it('unmounts the current default by moving the default to another included workspace first', () => {
    ...
    expect(onSetDefaultWorkspace).toHaveBeenCalledWith('/Users/luca/Work')
    expect(onUpdateWorkspaceIdentity).toHaveBeenCalledWith('/Users/luca/Grover', { mounted: false })
  })
  ...
  it('shows "Open local folder" option in vault menu', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onOpenLocalFolder={vi.fn()} />
    )
    fireEvent.click(screen.getByRole('button', { name: 'Switch vault' }))
  ...
  it('calls onOpenLocalFolder when clicking "Open local folder"', () => {
    ...
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onOpenLocalFolder={onOpenLocalFolder} />
    )
    fireEvent.click(screen.getByRole('button', { name: 'Switch vault' }))
  ...
  it('shows "Create empty vault" option in vault menu', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onCreateEmptyVault={vi.fn()} />
    )
    fireEvent.click(screen.getByRole('button', { name: 'Switch vault' }))
  ...
  it('calls onCreateEmptyVault when clicking "Create empty vault"', () => {
    ...
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onCreateEmptyVault={onCreateEmptyVault} />
    )
    fireEvent.click(screen.getByRole('button', { name: 'Switch vault' }))
  ...
  it('shows Changes badge with count when modifiedCount is > 0', () => {
    render(<StatusBar noteCount={100} modifiedCount={3} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} />)
  ...
  it('does not show Changes badge when modifiedCount is 0', () => {
    render(<StatusBar noteCount={100} modifiedCount={0} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} />)
  ...
  it('calls onClickPending when clicking the pending count', () => {
    ...
    render(
      <StatusBar noteCount={100} modifiedCount={5} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onClickPending={onClickPending} />
    )
  ...
  it('pending changes tooltip is available on keyboard focus', async () => {
    render(
      <StatusBar noteCount={100} modifiedCount={3} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onClickPending={vi.fn()} />
    )
  ...
  it('shows MCP warning badge when status is not_installed', async () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} mcpStatus="not_installed" />
    )
  ...
  it('hides MCP badge when status is installed', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} mcpStatus="installed" />
    )
  ...
  it('hides MCP badge when status is checking', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} mcpStatus="checking" />
    )
    expect(screen.queryByTestId('status-mcp')).not.toBeInTheDocument()
  })
  ...
  it('hides MCP badge when no mcpStatus prop provided', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} />
    )
    expect(screen.queryByTestId('status-mcp')).not.toBeInTheDocument()
  })
  ...
  it('hides MCP badge when AI features are disabled', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} aiFeaturesEnabled={false} mcpStatus="not_installed" />
    )
    expect(screen.queryByTestId('status-mcp')).not.toBeInTheDocument()
  })
  ...
  it('calls onInstallMcp when clicking MCP badge with not_installed status', () => {
    ...
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} mcpStatus="not_installed" onInstallMcp={onInstallMcp} />
    )
  ...
  it('shows Pull required label when syncStatus is pull_required', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} syncStatus="pull_required" />
    )
  ...
  it('shows an offline chip when offline', () => {
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} isOffline={true} />
    )
  ...
  it('calls onPullAndPush when clicking Pull required badge', () => {
    ...
    render(
      <StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} syncStatus="pull_required" onPullAndPush={onPullAndPush} />
    )
  ...
  it('keeps sync controls vault-agnostic when multiple vaults are active', () => {
    render(
      <StatusBar
        ...
        onSwitchVault={vi.fn()}
        repositories={[
          { path: '/Users/luca/Grover', label: 'Main Vault', defaultForNewNotes: true },
  ...
  it('shows History badge in status bar', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} isGitVault />)
    expect(screen.getByTestId('status-pulse')).toBeInTheDocument()
  ...
  it('calls onClickPulse when clicking History badge', () => {
    ...
    render(<StatusBar noteCount={100} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} isGitVault onClickPulse={onClickPulse} />)
  ...
  it('shows Commit button in status bar', () => {
    ...
    render(<StatusBar noteCount={100} modifiedCount={5} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onCommitPush={onCommitPush} />)
    expect(screen.getByTestId('status-commit-push')).toBeInTheDocument()
  ...
  it('shows Commit button even when no modified files', () => {
    render(<StatusBar noteCount={100} modifiedCount={0} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} onCommitPush={vi.fn()} />)
    expect(screen.getByTestId('status-commit-push')).toBeInTheDocument()
  })

  it('hides Commit button when no onCommitPush callback', () => {
    render(<StatusBar noteCount={100} modifiedCount={5} vaultPath="/Users/luca/Grover" vaults={vaults} onSwitchVault={vi.fn()} />)
    expect(screen.queryByTestId('status-commit-push')).not.toBeInTheDocument()
  })
