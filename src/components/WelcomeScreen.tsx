...
function getWelcomeScreenPresentation(
  ...
  if (mode === 'welcome') {
    return {
      ...
      heroIcon: <img src={groverIcon} alt="Grover icon" style={BRAND_ICON_STYLE} />,
      ...
      <>
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <OptionButton
            ...
            description="Start fresh in an empty folder with Grover defaults"
            loadingLabel="Creating vault…"
            loadingDescription="Preparing Grover defaults in the selected folder"
