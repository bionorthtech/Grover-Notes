...
const CONTRIBUTION_PATHS: ContributionPath[] = [
  ...
  },
  {
    ...
    url: GROVER_GITHUB_DISCUSSIONS_URL,
    icon: MessagesSquare,
    tone: 'purple',
  },
  {
    ...
    url: GROVER_GITHUB_PULL_REQUESTS_URL,
    icon: GitPullRequest,
    tone: 'yellow',
    secondaryLink: {
      ctaLabel: 'Open Contributing Guide',
      label: 'the contributing guide',
      url: GROVER_GITHUB_CONTRIBUTING_URL,
    },
  },
]
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <ContributionCard
        ...
        icon={Bug}
        tone="red"
        onAction={() => onOpenLink('GitHub Issues', GROVER_GITHUB_ISSUES_URL)}
        secondaryAction={(
          <BugReportActions
            copyState={copyState}
