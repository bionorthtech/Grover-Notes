...
describe('activeGitRepositories', () => {
  ...
  it('falls back to the path name when native omits a repository label', () => {
    expect(activeGitRepositories({
      defaultVaultPath: '/Users/luca/Workspace/grover',
      multiWorkspaceEnabled: true,
      vaults: [{ path: '/Users/luca/Workspace/grover', available: true, mounted: true } as VaultOption],
    })).toEqual([{
      path: '/Users/luca/Workspace/grover',
      label: 'grover',
