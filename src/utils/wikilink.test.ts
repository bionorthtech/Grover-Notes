...
describe('relativePathStem', () => {
  ...
  it('normalizes Windows extended-length paths before extracting the vault-relative stem', () => {
    expect(
      relativePathStem(
        '\\\\?\\C:\\Users\\lrfno\\Documents\\grover-vault\\application-design-and-build.md',
        'C:\\Users\\lrfno\\Documents\\grover-vault',
      ),
  ...
  it('keeps nested Windows note paths vault-relative with slash separators', () => {
    expect(
      relativePathStem(
        'C:\\Users\\lrfno\\Documents\\Grover Vault\\projects\\application-design-and-build.md',
        'c:/users/lrfno/documents/grover vault',
      ),
