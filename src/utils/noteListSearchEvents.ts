export const NOTE_LIST_SEARCH_AVAILABILITY_EVENT = 'grover:note-list-search-availability'
export const NOTE_LIST_SEARCH_TOGGLE_EVENT = 'grover:toggle-note-list-search'
