export const FRONTEND_READY_EVENT_NAME = 'grover:frontend-ready'
export const STARTUP_RELOAD_ATTEMPT_STORAGE_NAME = 'grover:startup-reload-attempted'

declare global {
  interface Window {
    __groverFrontendReady?: boolean
  }
}
...
export function markFrontendReady(options: FrontendReadyOptions = {}): void {
  ...
  win.__groverFrontendReady = true
...
export function reloadFrontendOnceIfStartupFailed(
  ...
  if (win.__groverFrontendReady === true) return false
