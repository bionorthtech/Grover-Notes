...
export function migrateLocalStorageToVaultConfig(loaded: VaultConfig | null): VaultConfig {
  ...
  applyJsonRecordMigration(result, 'tag_colors', LS_KEYS.tagColors, 'grover:tag-color-overrides')
  applyJsonRecordMigration(result, 'status_colors', LS_KEYS.statusColors, 'grover:status-color-overrides')
  applyJsonRecordMigration(result, 'property_display_modes', LS_KEYS.propertyModes, 'grover:display-mode-overrides')
