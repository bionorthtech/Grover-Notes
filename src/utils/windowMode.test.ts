  ...
  describe('findNoteWindowEntry', () => {
    it('returns direct and vault-expanded path candidates', () => {
      expect(getNoteWindowPathCandidates({
        ...
        vaultPath: '/Volumes/Jupiter/Workspace/grover-app/demo-vault-v2',
      })).toEqual([
        'demo-vault-v2/untitled-note-29.md',
        '/Volumes/Jupiter/Workspace/grover-app/demo-vault-v2/untitled-note-29.md',
        'untitled-note-29.md',
      ])
    })
    ...
    it('matches an absolute note path against vault-relative entries', () => {
      ...
      expect(findNoteWindowEntry([entry], {
        notePath: '/Volumes/Jupiter/Workspace/grover-app/demo-vault-v2/untitled-note-29.md',
        vaultPath: 'demo-vault-v2',
      })).toBe(entry)
    })

    it('matches a vault-relative note path against absolute entries', () => {
      const entry = makeEntry('/Volumes/Jupiter/Workspace/grover-app/demo-vault-v2/untitled-note-29.md')
    ...
    it('returns undefined when the target note is absent', () => {
      const entry = makeEntry('/Volumes/Jupiter/Workspace/grover-app/demo-vault-v2/other-note.md')
