...
function applyZoomToDocument(level: number): void {
  ...
  document.documentElement.style.setProperty('--grover-overlay-zoom-factor', String(level / DEFAULT_ZOOM))
  document.documentElement.style.setProperty('--grover-overlay-zoom-inverse', String(DEFAULT_ZOOM / level))
