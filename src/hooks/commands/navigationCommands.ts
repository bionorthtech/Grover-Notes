...
function buildBaseCommands(config: NavigationCommandsConfig): CommandAction[] {
  ...
  return [
    ...
    { id: 'import-source', label: 'Import source (Reddit / forum / web)', group: 'Insights', keywords: ['import', 'reddit', 'archive', 'clip', 'capture', 'forum', 'web', 'source'], enabled: !!onImportSource, execute: () => onImportSource?.() },
