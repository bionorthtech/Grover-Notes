...
- 💻 **New website!** – available at [Grover.md](http://grover.md/), now includes thorough docs and universal search with cmd+k
- 🤖 **Built-in Agent Docs** — Grover now bundles product documentation for local AI agents so guidance is available inside the app.
