...
- 🌏 **Indonesian Language Support** — Grover now includes an Indonesian translation alongside the existing supported languages.
...
- ⚡ **Faster AI Agent Startup** — Local AI agent discovery is deferred and parallelized so opening Grover does less blocking work up front.
