...
- 🇵🇱 **Polish Language Support** — Use Grover with a new Polish interface translation.
...
- ☀️ **Improved Light Mode Editing** — Read code blocks more comfortably when Grover is using the light theme.
